...
_init_gdt() {
    ...
    _set_gdt_entry(1, 0, 0xffffff, SEG_R0_CODE);
    _set_gdt_entry(2, 0, 0xffffff, SEG_R0_DATA);
    _set_gdt_entry(3, 0, 0xffffff, SEG_R3_CODE);
    _set_gdt_entry(4, 0, 0xffffff, SEG_R3_DATA);
}